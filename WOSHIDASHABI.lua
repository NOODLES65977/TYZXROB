...
wait(0.2) 
 Notification:Notify( 
     {Title = "TY中信", Description = "作者:特饮"}, 
     {OutlineColor = Color3.fromRGB(80, 80, 80),Time = 5, Type = "image"}, 
     {Image = "http://www.roblox.com/asset/?id=16060333448", ImageColor = Color3.fromRGB(155, 0, 0)} 
 ) 
 wait(2) 
 Notification:Notify( 
     {Title = "TY中信", Description = "感谢使用"}, 
     {OutlineColor = Color3.fromRGB(255, 0, 0),Time = 5, Type = "image"}, 
     {Image = "http://www.roblox.com/asset/?id=16060333448", ImageColor = Color3.fromRGB(155, 84, 84)} 
 )
